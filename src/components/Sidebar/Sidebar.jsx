    ...
    render(){
        return (
            <div className="sidebar" data-color={this.props.color} data-image={this.props.image}>
                {
                    this.props.hasImage ? (
                        <div className="sidebar-background" style={{backgroundImage: "url("+this.props.image+")"}}></div>
                    ):""
                }
                <div className="logo">
                	<a href="http://www.nhahangpos.com" className="simple-text logo-mini">
                        <div className="logo-img">
                            <img src={logo} alt="react-logo" />
                        </div>
                	</a>
                	<a href="http://www.nhahangpos.com" className="simple-text logo-normal">
                		NHÀ HÀNG POS
                	</a>
                </div>
                                ...
                                <ul className="nav">
                                    <li>
                						<a>
                							...
                							<span className="sidebar-normal">Trang cá nhân</span>
                						</a>
                					</li>
                					<li>
                						<a>
                							<span className="sidebar-mini">EP</span>
                							<span className="sidebar-normal">Lịch làm việc</span>
                						</a>
                					</li>
                					<li>
                						<a>
