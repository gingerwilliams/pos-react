            ...
            <div>
                ...
                <Nav pullRight>
                    ...
                    <NavDropdown
                        ...
                        <MenuItem eventKey={4.1}><i className="pe-7s-mail"></i> Nhắn tin</MenuItem>
                        <MenuItem eventKey={4.2}><i className="pe-7s-help1"></i> Trợ giúp</MenuItem>
                        <MenuItem eventKey={4.3}><i className="pe-7s-tools"></i> Cài đặt</MenuItem>
                        <MenuItem divider />
                        <MenuItem eventKey={4.4}><i className="pe-7s-lock"></i> Khóa màn hình</MenuItem>
                        <MenuItem eventKey={4.5}><div className="text-danger"><i className="pe-7s-close-circle"></i> Đăng xuất</div></MenuItem>
                    </NavDropdown>
                </Nav>
            </div>
        );
